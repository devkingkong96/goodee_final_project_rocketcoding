                                ...
                                <table id="example1"
                                    ...
                                    <c:forEach var="daybyStock" items="${daybyStockList }">
                                        <tr class="bt-5 border-primary">
                                            ...
                                            <td data-column-name="PRD_TITLE"
                                                data-table-name="PRODUCT"
                                                data-parent-column="PRD_TITLE">${daybyStock.TOTAL_STOCK_BY_PRD}</td>


                                            <td data-column-name="PRD_TITLE"
                                                data-table-name="PRODUCT"
                                                data-parent-column="PRD_TITLE">${daybyStock.PRICE_IN_STK}</td>

                                            <td data-column-name="PRD_AUTHOR"
                                                data-parent-column="PRD_AUTHOR"
                                                data-table-name="PRODUCT">${daybyStock.TOTAL_PRICE}</td>
